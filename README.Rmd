...
The goal of this repository then is to a) share some of the data I've collected^[I have since created a data package called [movienetData](https://github.com/pj398/movienetData) which is a more effective way for you to access the data, especially if you are an _R_ user.], and b) provide code for reproducing my work.
